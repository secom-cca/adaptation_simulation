...
const T = {
  en: {
    ...
    'budget.ruleNote':           'Budget decreases by 1 point for every $2,000,000 in flood damage and every 5 relocation points in each 25-year period.',
    ...
    'detail.llm.badge':     'PREVIEW',
    'detail.events.title':  'Event Log',
    'detail.events.sub':    'EVENT LOG',
    'detail.sns.title':     'Public Reaction',
    'detail.sns.sub':       'PUBLIC REACTION',
...
Overall Grade: B+`,
    ...
    'event.flood.body':         'Flood damage has exceeded critical levels. Residential areas downstream are inundated, and emergency evacuation is underway.',
    'event.drought.subtitle':   'CROP FAILURE',
    'event.drought.title':      'Heat-Driven Harvest Collapse',
    'event.drought.body':       'Rising temperatures without sufficient R&D investment have pushed crop yields below sustainable levels. Farmers across the basin are reporting severe losses.',
    'event.wq.subtitle':        'WATER QUALITY CRISIS',
    'event.wq.title':           'River Quality Deterioration',
    'event.wq.body':            'Reduced forest cover and disrupted water cycles have caused river transparency to plummet. Ayu sweetfish populations have collapsed and downstream drinking water treatment costs are rising sharply.',
    'event.ls.subtitle':        'LANDSLIDE',
    'event.ls.title':           'Mountain Landslide',
    'event.ls.body':            'Heavy rainfall struck a hillside with severely depleted forest cover, triggering a large landslide. Road networks are severed and evacuation routes are cut off.',
    'event.wf.subtitle':        'RANDOM EVENT — WILDFIRE',
    'event.wf.title':           'Large-Scale Wildfire',
    'event.wf.body':            'A wildfire has broken out and burned through 15% of the forest area. Water retention capacity and ecosystem health will be impacted in the coming cycle.',
    ...
    'ending.stats.flood':      'Cumulative Flood Damage (USD)',
  ...
  ja: {
    ...
    'budget.ruleNote':           '洪水被害2,000,000 USDごと、各25年で累計5ポイントの住宅移転ごとに、予算ポイントが1減ります。',
...
総合スコア：B+`,
    ...
    'event.ls.subtitle':        'LANDSLIDE',
    'event.ls.title':           '山体崩落',
    'event.ls.body':            '森林が極度に減少した山腹に大雨が直撃し、大規模な山体崩落が発生しました。道路網が寸断され、避難経路も断たれています。',
    'event.wf.subtitle':        'RANDOM EVENT — 森林火災',
    'event.wf.title':           '大規模山林火災',
    'event.wf.body':            '山林火災が発生し、森林面積の15%が焼失しました。次サイクルの保水能力と生態系に影響が出ます。',
    ...
    'ending.stats.flood':      '累計洪水被害額 (USD)',
