...
const T = {
  en: {
    ...
    'ending.export.hint': 'The operation log (including survey answers) is saved when you press Play Again.',
  ...
  ja: {
    ...
    'ending.export.hint': '操作ログ（アンケート回答を含む）は「もう一度プレイ」を押したときにサーバへ保存されます。',
