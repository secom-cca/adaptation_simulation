...
const T = {
  en: {
    ...
    'ending.export.hint': 'The operation log (including survey answers) is saved when you press Play Again on the survey screen, or when you skip the survey.',
  ...
  ja: {
    ...
    'ending.export.hint': '操作ログ（アンケート回答を含む）は、アンケート画面の「もう一度プレイ」または「アンケートをスキップする」でサーバへ保存されます。',
