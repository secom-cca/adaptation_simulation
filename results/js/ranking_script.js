...
document.getElementById("bunya0_top1score").innerText=bunya0_top3[0][2].toFixed(2);
document.getElementById("bunya0_top2name").innerText =bunya0_top3[1][1];
document.getElementById("bunya0_top2score").innerText=bunya0_top3[1][2].toFixed(2);
document.getElementById("bunya0_top3name").innerText =bunya0_top3[2][1];
document.getElementById("bunya0_top3score").innerText=bunya0_top3[2][2].toFixed(2);
document.getElementById("bunya0_yourrank").innerText=rankyou[0];
document.getElementById("bunya0_yourname").innerText=yourname;
document.getElementById("bunya0_yourpoint").innerText=score2100[0].toFixed(2);

document.getElementById("bunya1_top1name").innerText =bunya1_top3[0][1];
document.getElementById("bunya1_top1score").innerText=bunya1_top3[0][2].toFixed(2);
document.getElementById("bunya1_top2name").innerText =bunya1_top3[1][1];
document.getElementById("bunya1_top2score").innerText=bunya1_top3[1][2].toFixed(2);
document.getElementById("bunya1_top3name").innerText =bunya1_top3[2][1];
document.getElementById("bunya1_top3score").innerText=bunya1_top3[2][2].toFixed(2);
document.getElementById("bunya1_yourrank").innerText=rankyou[1];
document.getElementById("bunya1_yourname").innerText=yourname;
document.getElementById("bunya1_yourpoint").innerText=score2100[1].toFixed(2);

document.getElementById("bunya2_top1name").innerText =bunya2_top3[0][1];
document.getElementById("bunya2_top1score").innerText=bunya2_top3[0][2].toFixed(2);
document.getElementById("bunya2_top2name").innerText =bunya2_top3[1][1];
document.getElementById("bunya2_top2score").innerText=bunya2_top3[1][2].toFixed(2);
document.getElementById("bunya2_top3name").innerText =bunya2_top3[2][1];
document.getElementById("bunya2_top3score").innerText=bunya2_top3[2][2].toFixed(2);
document.getElementById("bunya2_yourrank").innerText=rankyou[2];
document.getElementById("bunya2_yourname").innerText=yourname;
document.getElementById("bunya2_yourpoint").innerText=score2100[2].toFixed(2);

document.getElementById("bunya3_top1name").innerText =bunya3_top3[0][1];
document.getElementById("bunya3_top1score").innerText=bunya3_top3[0][2].toFixed(2);
document.getElementById("bunya3_top2name").innerText =bunya3_top3[1][1];
document.getElementById("bunya3_top2score").innerText=bunya3_top3[1][2].toFixed(2);
document.getElementById("bunya3_top3name").innerText =bunya3_top3[2][1];
document.getElementById("bunya3_top3score").innerText=bunya3_top3[2][2].toFixed(2);
document.getElementById("bunya3_yourrank").innerText=rankyou[3];
document.getElementById("bunya3_yourname").innerText=yourname;
document.getElementById("bunya3_yourpoint").innerText=score2100[3].toFixed(2);

document.getElementById("bunya4_top1name").innerText =bunya4_top3[0][1];
document.getElementById("bunya4_top1score").innerText=bunya4_top3[0][2].toFixed(2);
document.getElementById("bunya4_top2name").innerText =bunya4_top3[1][1];
document.getElementById("bunya4_top2score").innerText=bunya4_top3[1][2].toFixed(2);
document.getElementById("bunya4_top3name").innerText =bunya4_top3[2][1];
document.getElementById("bunya4_top3score").innerText=bunya4_top3[2][2].toFixed(2);
document.getElementById("bunya4_yourrank").innerText=rankyou[4];
document.getElementById("bunya4_yourname").innerText=yourname;
document.getElementById("bunya4_yourpoint").innerText=score2100[4].toFixed(2);

document.getElementById("total_top1name").innerText =total_top3[0][1];
document.getElementById("total_top1score").innerText=total_top3[0][2].toFixed(2);
document.getElementById("total_top2name").innerText =total_top3[1][1];
document.getElementById("total_top2score").innerText=total_top3[1][2].toFixed(2);
document.getElementById("total_top3name").innerText =total_top3[2][1];
document.getElementById("total_top3score").innerText=total_top3[2][2].toFixed(2);
document.getElementById("total_yourrank").innerText=rankyou[5];
document.getElementById("total_yourname").innerText=yourname;
document.getElementById("total_yourpoint").innerText=sum2100.toFixed(2);

document.getElementById("bunyabalance_top1name").innerText =bunyabalance_top3[0][1];
document.getElementById("bunyabalance_top1score").innerText=bunyabalance_top3[0][2].toFixed(2);
document.getElementById("bunyabalance_top2name").innerText =bunyabalance_top3[1][1];
document.getElementById("bunyabalance_top2score").innerText=bunyabalance_top3[1][2].toFixed(2);
document.getElementById("bunyabalance_top3name").innerText =bunyabalance_top3[2][1];
document.getElementById("bunyabalance_top3score").innerText=bunyabalance_top3[2][2].toFixed(2);
...
document.getElementById("bunyabalance_yourpoint").innerText=bunyabalancescore.toFixed(2);

document.getElementById("sedaibalance_top1name").innerText =sedaibalance_top3[0][1];
document.getElementById("sedaibalance_top1score").innerText=sedaibalance_top3[0][2].toFixed(2);
document.getElementById("sedaibalance_top2name").innerText =sedaibalance_top3[1][1];
document.getElementById("sedaibalance_top2score").innerText=sedaibalance_top3[1][2].toFixed(2);
document.getElementById("sedaibalance_top3name").innerText =sedaibalance_top3[2][1];
document.getElementById("sedaibalance_top3score").innerText=sedaibalance_top3[2][2].toFixed(2);
...
document.getElementById("sedaibalance_yourpoint").innerText=sedaibalancescore.toFixed(2);