...
document.getElementById("res2050_0").innerText=score2050[0];
document.getElementById("res2050_1").innerText=score2050[1];
document.getElementById("res2050_2").innerText=score2050[2];
document.getElementById("res2050_3").innerText=score2050[3];
document.getElementById("res2050_4").innerText=score2050[4];
document.getElementById("res2050_sum").innerText=sum2050;

document.getElementById("res2075_0").innerText=score2075[0];
document.getElementById("res2075_1").innerText=score2075[1];
document.getElementById("res2075_2").innerText=score2075[2];
document.getElementById("res2075_3").innerText=score2075[3];
document.getElementById("res2075_4").innerText=score2075[4];
document.getElementById("res2075_sum").innerText=sum2075;

document.getElementById("res2100_0").innerText=score2100[0];
document.getElementById("res2100_1").innerText=score2100[1];
document.getElementById("res2100_2").innerText=score2100[2];
document.getElementById("res2100_3").innerText=score2100[3];
document.getElementById("res2100_4").innerText=score2100[4];
document.getElementById("res2100_sum").innerText=sum2100;
