...
# 以下の函数は Streamlit 用のため、FastAPI 后端では不需要
# def create_line_chart(...): pass
# def create_scatter_plot(...): pass
# def compare_scenarios(...): pass
# def compare_scenarios_yearly(...): pass
